...
(function () {
  ...
  const EN = {
    ...
    'KOLEKSİYONU': 'THE COLLECTION',
    'Kataloğu görüntüle': 'View the catalogue',
    'Nasıl başladı': 'How it started',
    'Ekiplerimiz': 'Our casts',
    'Sahada': 'On site',
    'KURULUM': 'SET-UP',
    'Opsiyonel ekler': 'Optional extras',
    'Mim sanatçıları': 'Mime artists',
    'Canlı saksafon': 'Live saxophone',
    'Genişletilmiş dans grubu': 'Extended dance troupe',
    'Kadro ve dekor tesisinize ve bütçenize göre genişletilebilir.': 'Cast and décor can be extended to suit your resort and budget.',
    'Standart kurulum': 'Standard set-up',
